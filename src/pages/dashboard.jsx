...
export default function Dashboard() {
  ...
  return (
    ...
    <div className="flex justify-center items-center mx-auto max-w-[80%] min-h-screen">
      ...
      <form onSubmit={handleSubmit} className="absolute top-50 left-1/2 transform -translate-x-1/2 flex flex-col w-7/8 gap-5">
        <label className="font-medium text-center text-[#012a57] font-Roboto text-2xl">Add Your Transaction</label>
        <input
          type="number"
          ref={cost}
